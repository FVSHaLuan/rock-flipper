...
namespace XNodeEditor
{
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node>
    {
        ...
        public virtual HashSet<string> ExcludedFields { get => excludedFields; }
        ...
        protected virtual void DrawFields()
        {
            ...
            {
                enterChildren = false;
                if (ExcludedFields.Contains(iterator.name)) continue;

                ///
                if (target.graph.HideInputOutputHandles)
                {
                    NodeEditorUtilities.GetCachedAttrib(target.GetType(), iterator.name, out InputAttribute inputAttribute);
                    NodeEditorUtilities.GetCachedAttrib(target.GetType(), iterator.name, out OutputAttribute outputAttribute);
