...
namespace XNodeEditor
{
    ...
    public static class NodeEditorPreferences
    {
        ...
        public class Settings : ISerializationCallbackReceiver
        {
            ...
            private Texture2D _gridTexture256;
            public Texture2D gridTexture256
            {
                get
                {
                    if (_gridTexture256 == null) _gridTexture256 = NodeEditorResources.GenerateGridTexture256(gridLineColor, gridBgColor);
                    return _gridTexture256;
                }
            }
