...
namespace CommandTerminal
{
    ...
    public struct CommandArg
    {
        ...
        public double Double
        {
            get
            {
                ...
                if (double.TryParse(String, out double_value))
                {
                    return double_value;
                }
        ...
        {
            CommandShell.IssueErrorMessage(
    ...
    public class CommandShell
    {
        ...
        /// </summary>
        public CommandArg[] RunCommand(string line)
        {
            IssuedErrorMessage = null;
            GetArguments(line, arguments);
            ...
            ///
            RunCommand(command_name, argumentsArray);

            ///
            return argumentsArray;
        }

        public static void GetArguments(string line, List<CommandArg> arguments)
        {
        ...
        public static void IssueErrorMessage(string format, params object[] message)
        {
