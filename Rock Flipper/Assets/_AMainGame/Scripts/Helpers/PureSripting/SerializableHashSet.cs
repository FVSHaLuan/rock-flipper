...
[System.Serializable]
public class SerializableHashSetString : SerializableHashSet<string>
{
    public SerializableHashSetString() : base() { }
    public SerializableHashSetString(ISet<string> set) : base(set) { }
    protected SerializableHashSetString(SerializationInfo info, StreamingContext context) : base(info, context) { }
}
#endif